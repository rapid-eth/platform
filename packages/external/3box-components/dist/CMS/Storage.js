...
var StorageSelector = (_ref) => {
  ...
  var SetSelectionEffect = () => (0, _react.useEffect)(() => {
    setSelection((0, _dotPropImmutableChain.default)(box).get("data.spaces.".concat(selector)).value());
  }, [(0, _dotPropImmutableChain.default)(box).get("data.spaces.".concat(selector)).value()]);
  /**
