...
var MessagingSelector = (_ref) => {
  ...
  var SetSelectionEffect = () => (0, _react.useEffect)(() => {
    setSelection((0, _dotPropImmutableChain.default)(box).get("data.threads.".concat(threadName, ".posts")).value());
  }, [(0, _dotPropImmutableChain.default)(box).get("data.threads.".concat(threadName, ".posts")).value()]);
  /**
  ...
  var SetSelectionOnceEffect = () => (0, _react.useEffect)(() => {
    if (!selection) setSelection((0, _dotPropImmutableChain.default)(box).get("data.spaces.".concat(selector)).value());
  }, [selection, (0, _dotPropImmutableChain.default)(box).get("data.spaces.".concat(selector)).value()]);
  /* --- Init Effects ---*/
...
var _default = props => _react.default.createElement(_dist.BoxWrapper, null, _react.default.createElement(MessagingSelector, props));
