...
var BoxLoginCard = (_ref) => {
  ...
  return !box.address ? _react.default.createElement(_BoxLoginButton.default, null) : _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_designSystem.Box, _extends({
    p: 0
  }, styled, props), _react.default.createElement(_designSystem.Box, _extends({
    x: true,
    column: true,
    height: "100%"
    ...
    mb: 3,
    fontSize: [2]
  }, profile.job, " ", profile.employer && _react.default.createElement(_designSystem.Span, null, "at ", profile.employer)), _react.default.createElement(_designSystem.Box, null, _react.default.createElement(_BoxLoginButton.default, {
    mb: 20
