...
var MemberAdd = (_ref3) => {
  ...
  return _react.default.createElement(Box, null, _react.default.createElement(Heading, null, "Add Member"), _react.default.createElement(BoxMemberAdd, null));
};

var ModeratorAdd = (_ref4) => {
  var {
    styled
  } = _ref4,
      props = _objectWithoutProperties(_ref4, ["styled"]);

  return _react.default.createElement(Box, null, _react.default.createElement(Heading, null, "Add Moderator"), _react.default.createElement(BoxModeratorAdd, null));
};