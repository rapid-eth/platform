...
var BoxOpenSpace = (_ref) => {
  ...
  return !auto ? loading ? componentLoading ? componentLoading : _react.default.createElement(_designSystem.Box, {
    fullWidth: true
  }, _react.default.createElement(_designSystem.Button, styledLoading, "Loading Space...")) : _react.default.createElement(_designSystem.Box, {
    fullWidth: true,
    onClick: actionHandler
  }, children ? children : _react.default.createElement(_designSystem.Button, styled, "open ", _react.default.createElement("strong", null, space), " space")) : null;
};
