...
var BoxVerified = (_ref) => {
  ...
  return !box.verifications ? loadingMessage ? _react.default.createElement(_designSystem.Span, null, loadingMessage) : null : _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_designSystem.Flex, {
    between: true
    ...
    maxWidth: 18,
    mr: 2
  }), _react.default.createElement(_designSystem.Span, null, "Verify"))) : _react.default.createElement(_designSystem.Span, {
    xxs: true,
    tag: "white"
    ...
    maxWidth: 18,
    mr: 2
  }), _react.default.createElement(_designSystem.Span, null, box.verifications.github.username)))), !isTwitter ? _react.default.createElement(_designSystem.Span, {
    xxs: true,
    thin: true,
    tag: "white",
    mx: 2
    ...
    maxWidth: 18,
    mr: 2
  }), _react.default.createElement(_designSystem.Span, null, box.verifications.twitter.username)))), !isEmail ? _react.default.createElement(_designSystem.Span, {
    xxs: true,
    thin: true,
    tag: "white"
  }, _react.default.createElement(_designSystem.Flex, {
    ...
    maxWidth: 18,
    mr: 2
  }), _react.default.createElement(_designSystem.Span, null, "Unlock"))) : isEmailVerified ? _react.default.createElement(_designSystem.Span, {
    xxs: true,
    tag: "white"
