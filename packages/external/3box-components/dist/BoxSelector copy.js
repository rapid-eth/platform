...
var BoxSelector = (_ref) => {
  ...
  return selection ? Array.isArray(selection) ? selection.map(item => !_react.default.isValidElement(props.component) ? _react.default.createElement(props.component, _objectSpread({}, item)) : props.component) : _react.default.isValidElement(props.component) ? _react.default.createElement(props.component, _objectSpread({}, item)) : props.component : null;
};
