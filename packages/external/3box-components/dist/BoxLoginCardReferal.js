...
var BoxLoginCard = (_ref) => {
  ...
  (0, _react.useEffect)(() => {
    ...
    if (box.address && props.addressReferrer) {
      ...
      var url = 'https://brn68gkbcf.execute-api.us-east-1.amazonaws.com/cors/verify-referral';
      window.fetch(url, {
        method: 'POST',
        cache: 'no-cache',
  ...
  return !box.address ? _react.default.createElement(_BoxLoginButton.default, null) : _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_designSystem.Box, _extends({
    p: 0
  }, styled, props), "reff", _react.default.createElement(_designSystem.Box, _extends({
    x: true,
    column: true,
    height: "100%"
  }, styledInner), _react.default.createElement(_designSystem.Flex, {
    flex: 1,
    p: 2,
    ...
    gradient: "purpink",
    gradientDir: "140 "
  }), isCover && _react.default.createElement(_designSystem.BackgroundImage, {
    ...
    maxWidth: 320,
    alignSelf: "center"
  }, isImage ? _react.default.createElement(_designSystem.Image, {
    circle: true,
    card: true,
  ...
  }), isJob && _react.default.createElement(_designSystem.Span, {
    textCenter: true,
    mb: 3,
    fontSize: [2]
  }, profile.job, " ", profile.employer && _react.default.createElement(_designSystem.Span, null, "at ", profile.employer)), _react.default.createElement(_designSystem.Box, {
    textCenter: true
  }, _react.default.createElement(_designSystem.Heading, null, "Congratulations!"), _react.default.createElement(_designSystem.Heading, {
    sm: true,
    thin: true
  }, "You're Connected to the Referrer")), _react.default.createElement(_BoxVerified.default, null), !isName || !isJob && _react.default.createElement(_BoxFormProfileBasics.default, null))), isFooterActive && _react.default.createElement(_designSystem.Flex, {
    center: true,
    card: true,
    flex: 1,
    p: 10
...
var ProfileEdit = (_ref2) => {
  ...
  return _react.default.createElement(_designSystem.Box, {
    ...
    p: 20,
    minWidth: 270
  }, _react.default.createElement(_BoxFormProfileBasics.default, null));
};

var _default = props => _react.default.createElement(_dist.BoxWrapper, null, _react.default.createElement(BoxLoginCard, props));
