...
var BoxLoginButton = (_ref) => {
  ...
  return !box.instance ? _react.default.createElement(ButtonLogin, _extends({
    ...
    variant: variant
  }, styled)) : box.profile && box.isLoggedIn ? box.profile.name ? _react.default.createElement(_designSystem.Flex, {
    alignCenter: true
    ...
    white: true,
    variant: variant
  }, styled), box.profile.name)) : _react.default.createElement(_designSystem.Button, null, "Setup Profile") : _react.default.createElement(ButtonLogin, {
    open: box.open,
    isLoggingIn: box.isLoggingIn,
    variant: variant,
    children: children,
