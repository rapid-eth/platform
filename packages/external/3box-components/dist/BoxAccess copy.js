...
var LevelThread = (_ref4) => {
  ...
  var spaceLoaded = (0, _idx.default)(box, _ => _.spaces[props.space].instance);
  var threadLoaded = (0, _idx.default)(box, _ => _.threads[props.threadName].instance);
  return _react.default.createElement(_react.default.Fragment, null, !isLoggedIn && !spaceLoaded && !threadLoaded ? componentLogin ? componentLogin : isLoginDisabled ? null : null : null, isLoggedIn && !spaceLoaded && _react.default.createElement(_index.BoxSpaceOpen, {
    ...
    space: space
  }, _react.default.createElement(_react.default.Fragment, null, componentThread ? componentThread : _react.default.createElement(_designSystem.Button, styledThread, "Join ", threadName, " Thread"))), isLoggedIn && spaceLoaded && threadLoaded && children);
};