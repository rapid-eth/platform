...
import { 
  BackgroundGradient, BackgroundImage, QRDisplayModal, QRStyled, QRDisplay,
  Box, Button, Heading, Span, Flex, Image, Toast, Paragraph, Absolute} from '@horizin/design-system'
...
import { HorizontalRule } from '@horizin/design-system/dist/atoms'
/* --- React Component --- */
const BoxLoginCard = ({ 
  box,
  isFooterActive,
