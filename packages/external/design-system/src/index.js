...
export { default as BackgroundGradient } from './atoms/BackgroundGradient';
...
export { default as Dashboard } from './templates/Dashboard';
export { default as Site } from './templates/Site';
