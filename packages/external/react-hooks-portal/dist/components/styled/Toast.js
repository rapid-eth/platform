...
var Toast = (0, _styledComponents.default)(_dist.Box)(_templateObject(), (0, _styledSystem.variant)({
  prop: 'location',
  variants: {
    topRight: {
      top: 0,
...
var ToastActions = (_ref) => {
  ...
  return _react.default.createElement(_reactTransitionGroup.CSSTransition, {
    ...
    timeout: 300,
    classNames: "alert"
  }, !isOpening ? _react.default.createElement("div", null) : _react.default.createElement(Toast, _extends({
    card: true,
    p: 3,
    portal: portal,
    id: id,
    open: true
  }, styled, styled), _react.default.createElement(_dist.Box, null, label && _react.default.createElement(_dist.Span, {
    xs: true
  }, label), _react.default.createElement(_dist.Absolute, {
    layout: "topRight",
    m: -3
