...
var ContentTypeAdventure = (_ref) => {
  ...
  (0, _react.useEffect)(() => {
    if (!index && (0, _idx.default)(box, _ => _.spaces[props.space].public[props.insert])) {
      var _index = (0, _idx.default)(box, _ => _.spaces[props.space].public[props.insert][props.key]);
