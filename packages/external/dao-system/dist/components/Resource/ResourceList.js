...
var _ResourceItemSmall = _interopRequireDefault(require("./components/ResourceItemSmall"));
 ...
 */
var ResourceListComponent = (_ref) => {
  var {
    box
  } = _ref,
...
var ResourceListStateful = props => _react.default.createElement(_dist.BoxWrapper, null, _react.default.createElement(ResourceListComponent, props));

ResourceListComponent.defaultProps = {
  component: _ResourceItemSmall.default,
  key: 'resource'
};
...
var _default = ResourceListStateful;
