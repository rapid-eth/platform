...
var _AdventureItem = _interopRequireDefault(require("./components/AdventureItem"));
 ...
 */
var AdventureListComponent = (_ref) => {
  var {
    box
  } = _ref,
...
var AdventureListStateful = props => _react.default.createElement(_dist.BoxWrapper, null, _react.default.createElement(AdventureListComponent, props));

AdventureListComponent.defaultProps = {
  component: _AdventureItem.default,
  key: 'adventure'
};
...
var _default = AdventureListStateful;
