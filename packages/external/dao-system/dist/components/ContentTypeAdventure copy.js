...
var ContentTypeAdventure = (_ref) => {
  ...
  (0, _react.useEffect)(() => {
    if (!index && (0, _idx.default)(box, _ => _.spaces[props.space].public.index)) {
      var _index = (0, _idx.default)(box, _ => _.spaces[props.space].public[props.insert].payload[props.key]);
  ...
  return _react.default.createElement(_designSystem.Flex, {
    ...
    md: true,
    thin: true
  }, title), index ? _react.default.createElement(_designSystem.Button, {
    xxs: true,
    variant: "white",
