...
var ProjectItem = (_ref) => {
  ...
  return _react.default.createElement(_designSystem.Flex, _extends({
    ...
    alignCenter: true,
    between: true
  }, props.stlyed), _react.default.createElement(_designSystem.Flex, null, _react.default.createElement(_designSystem.Heading, {
    lg: true
  }, props.name)), _react.default.createElement(_designSystem.Flex, null, _react.default.createElement(_designSystem.Button, {
    xs: true,
    variant: "white"
  }, "View")));
};
