...
var UserItemSmall = props => {
  return _react.default.createElement(_designSystem.Flex, _extends({
    between: true,
    card: true
  }, props.styled), _react.default.createElement(_designSystem.Flex, {
    alignCenter: true
    ...
    normal: true,
    noMargin: true
  }, props.name, _react.default.createElement(_designSystem.Span, {
    sm: true,
    ml: 3
  }, " ", props.job, " ", props.employer && _react.default.createElement(_designSystem.Span, {
    heavy: true
  }, props.employer))))), _react.default.createElement(_designSystem.Flex, null, _react.default.createElement(_designSystem.Panel, {
    content: _react.default.createElement(ProfilePanel, props)
  }, _react.default.createElement(_designSystem.Span, {
    xxs: true,
    tag: "white"
  }, "View Profile")), _react.default.createElement(_designSystem.Panel, {
    content: _react.default.createElement(ProfilePanel, props)
  }, _react.default.createElement(_designSystem.Span, {
    xxs: true,
    tag: "green"
