...
var ERC20TotalSupply = (_ref) => {
  ...
  var [totalSupply, setSupply] = (0, _react.useState)(0);
  /**
    ...
    var _ref2 = _asyncToGenerator(function* () {
      try {
        if (ethers.contracts[props.address]) {
          ...
          yield ethers.contracts[props.address].totalSupply() // Read Public Function
          )));
  ...
  return _react.default.createElement(_designSystem.Heading, styled, " ", _react.default.createElement(_designSystem.Span, props.styledLabel, props.label), ": ", totalSupply);
};
...
var _default = props => _react.default.createElement(_ethersReact.EthersWrapper, null, _react.default.createElement(ERC20TotalSupply, props));
