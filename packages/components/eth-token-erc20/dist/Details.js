...
var ERC20Details = (_ref) => {
  ...
  return {
    full: _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_designSystem.Heading, props.styled, _react.default.createElement(_designSystem.Span, props.styledLabel, props.label, ": "), _react.default.createElement(_designSystem.Span, {
      ml: 2
    ...
    name: _react.default.createElement(_designSystem.Span, props.styled, name),
    symbol: _react.default.createElement(_designSystem.Span, props.styled, symbol)
  }[props.variant];
};
...
var _default = props => _react.default.createElement(_ethersReact.EthersWrapper, null, _react.default.createElement(ERC20Details, props));
