...
const Home = ({ styled, ...props }) =>
  <>
    ...
    <Flex fullWidth minHeight={'100vh'}>
      <Flex justifyCenter column flex={1} p={200}>
        ...
        <Flex fullWidth mt={30}>
          <Button sm variant='orange'>How It Works</Button>
          <Button sm ml={15}>Getting Started</Button>
        </Flex>
      </Flex>
    ...
    <Flex center column gradient='black' gradientDir='45' py={[150]}>
    ...
    <Box>
      <Container py={80}>
        <Flex alignCenter>
          ...
          <Flex column flex={1} p={40}>
            <Heading xxl noMargin>Expand Your Network</Heading>
